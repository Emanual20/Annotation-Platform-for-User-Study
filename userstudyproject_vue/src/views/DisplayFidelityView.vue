<template>
    <div class="displaycombination">
      ...
      <div class="ifloginview" v-if="$store.state.user.is_login">
          ...
          <div class="choosedisplaynum_then">
              ...
              <h5>1. 基于您所看到的解释，您认为左右两个推荐列表哪个列表对商家的排序更合理？</h5>
              <div class="row">
                <div class="col form-check form-check-inline">
                    <input class="form-check-input" type="radio" v-model="fidelity_degree" name="inlineRadioOptions" id="inlineRadio1" value="-2">
                    <label class="form-check-label" for="inlineRadio1">-2（左侧列表更合理）</label>
                </div>
                <div class="col form-check form-check-inline">
                    <input class="form-check-input" type="radio" v-model="fidelity_degree" name="inlineRadioOptions" id="inlineRadio2" value="-1">
                    <label class="form-check-label" for="inlineRadio2">-1</label>
                </div>
                <div class="col form-check form-check-inline">
                    <input class="form-check-input" type="radio" v-model="fidelity_degree" name="inlineRadioOptions" id="inlineRadio3" value="0">
                    <label class="form-check-label" for="inlineRadio3">0（我无法判断）</label>
                </div>
                <div class="col form-check form-check-inline">
                    <input class="form-check-input" type="radio" v-model="fidelity_degree" name="inlineRadioOptions" id="inlineRadio4" value="1">
                    <label class="form-check-label" for="inlineRadio3">+1</label>
                </div>
                <div class="col form-check form-check-inline">
                    <input class="form-check-input" type="radio" v-model="fidelity_degree" name="inlineRadioOptions" id="inlineRadio5" value="2">
                    <label class="form-check-label" for="inlineRadio3">+2（右侧列表更合理）</label>
                </div>
              </div>
  ...
  export default {
    ...
    methods:{
      ...
      clicktosubmit(){
        // if(this.usefulness_degree == -2048){
        ...
        // else
        {
            const Params = reactive({
                ...
                attrs: {
                    property: "fidelity",
                    fidelity_degree: this.fidelity_degree,
                },
